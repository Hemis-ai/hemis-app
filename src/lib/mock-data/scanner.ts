...
export const MOCK_FINDINGS: ScanFinding[] = [
  ...
  },
  {
    ...
    description: 'Security group "sg-0a4f7b2c1d3e8f9a0" allows unrestricted SSH access from any IPv4 address. Attached to 3 production instances.',
  ...
  },
  {
    ...
    description: '"process-payments" Lambda has an execution role with s3:*, rds:*, and iam:PassRole. Function only requires S3 GetObject on a specific prefix.',
  ...
  },
  {
    ...
    description: 'Bucket "dev-static-assets" does not have versioning enabled. Accidental deletions cannot be recovered.',
  ...
  },
  {
    ...
    description: 'Production VPC "vpc-0c8d2f1a4b5e6c7d" does not have VPC Flow Logs enabled. Network traffic cannot be audited.',
    remediation: 'Enable VPC Flow Logs to CloudWatch Logs or S3. Configure log retention policy.',
    compliance: ['SOC2-CC7.2', 'ISO27001-A.12.4'],
  ...
  },
  {
    ...
    description: 'Instance "i-0a1b2c3d4e5f6a7b8" (api-server-prod-3) is assigned a public IP despite being in a private subnet.',
    remediation: 'Remove public IP assignment. Access through NAT Gateway or Application Load Balancer.',
  ...
  },
  {
    ...
    remediation: 'Deactivate or delete unused IAM user. Review access key usage before removal.',
